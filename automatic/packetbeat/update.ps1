...
# $url = 'https://www.elastic.co/downloads/beats/packetbeat'
$url = 'https://www.elastic.co/downloads/past-releases/packetbeat-6-8-7'
...
function global:au_GetLatest {
    ...
    $x = ($links | ? { $_.href -imatch "x86_64.zip.sha" -and $_.href -match "zip\.(\w+)$" }).href | select -first 1
